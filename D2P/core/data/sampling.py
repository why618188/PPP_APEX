...
class GraphDensitySampler(SamplingMethod):
  ...
  def __init__(self, X, gamma=None, importance_scores=None, n_neighbor=10, graph_mode='product', graph_sampling_mode='absolute',
  ...
  # def __init__(self, X, y, seed, gamma=None, importance_scores=None, args=None):
    ...
    if precomputed_dists and precomputed_neighbors:
      self.precomputed = True
      self.initialize_with_precomputed_graph(precomputed_dists, precomputed_neighbors, importance_scores, n_neighbor=n_neighbor)
    else:
      self.precomputed = False
      self.compute_graph_density(n_neighbor=n_neighbor, importance_scores=importance_scores)
